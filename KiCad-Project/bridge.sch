...
F 2 "handcart-footprints:PowerDI5060-8_SGD" H 4850 3300 50  0001 C CNN
...
F 2 "handcart-footprints:PowerDI5060-8_SGD" H 4850 3900 50  0001 C CNN
...
F 2 "Capacitor_SMD:C_0805_2012Metric" H 3138 2850 50  0001 C CNN
...
AR Path="/5CF15E95/5CF1692B" Ref="#PWR0404"  Part="1" 
F 0 "#PWR0404" H 2600 3950 50  0001 C CNN
...
F 2 "Capacitor_THT:CP_Radial_D17.0mm_P7.50mm" H 6338 3050 50  0001 C CNN
...
AR Path="/5CF15E95/5CF16947" Ref="#PWR0407"  Part="1" 
F 0 "#PWR0407" H 4750 3950 50  0001 C CNN
...
F 2 "handcart-footprints:PowerDI5060-8_SGD" H 4850 5600 50  0001 C CNN
...
F 2 "handcart-footprints:PowerDI5060-8_SGD" H 4850 6200 50  0001 C CNN
...
AR Path="/5CF15E95/5CF16990" Ref="#PWR0406"  Part="1" 
F 0 "#PWR0406" H 2600 6250 50  0001 C CNN
...
F 2 "Capacitor_THT:CP_Radial_D17.0mm_P7.50mm" H 6338 5350 50  0001 C CNN
...
AR Path="/5CF15E95/5CF169AC" Ref="#PWR0408"  Part="1" 
F 0 "#PWR0408" H 4750 6250 50  0001 C CNN
...
AR Path="/5CF15E95/5CF169C3" Ref="R404"  Part="1" 
F 0 "R404" H 7370 4946 50  0000 L CNN
F 1 "0R75" H 7370 4855 50  0000 L CNN
F 2 "Resistor_THT:R_Axial_DIN0414_L11.9mm_D4.5mm_P15.24mm_Horizontal" V 7230 4900 50  0001 C CNN
...
AR Path="/5CF15E95/5CF169CA" Ref="C411"  Part="1" 
F 0 "C411" H 7415 4546 50  0000 L CNN
F 1 "47n" H 7415 4455 50  0000 L CNN
F 2 "Capacitor_THT:C_Rect_L7.2mm_W7.2mm_P5.00mm_FKS2_FKP2_MKS2_MKP2" H 7338 4350 50  0001 C CNN
...
AR Path="/5CF15E95/5CF16923" Ref="#PWR0403"  Part="1" 
F 0 "#PWR0403" H 2600 2250 50  0001 C CNN
...
AR Path="/5CF15E95/5CF16988" Ref="#PWR0405"  Part="1" 
F 0 "#PWR0405" H 2600 4550 50  0001 C CNN
...
U 1 1 5CF18722
P 8400 1500
F 0 "#PWR0409" H 8400 1350 50  0001 C CNN
...
AR Path="/5CF15E95/5CF22580" Ref="#PWR0411"  Part="1" 
F 0 "#PWR0411" H 9250 2150 50  0001 C CNN
...
U 1 1 5CF256A5
P 9250 1500
F 0 "#PWR0410" H 9250 1350 50  0001 C CNN
...
Wire Wire Line
	9250 1500 9250 1600
$Comp
L Device:R_Shunt R405
U 1 1 5CF2D77E
P 8400 1900
F 0 "R405" H 8312 1946 50  0000 R CNN
F 1 "200uR" H 8312 1855 50  0000 R CNN
F 2 "handcart-footprints:PCB_Shunt_200uR" V 8330 1900 50  0001 C CNN
...
AR Path="/5CF15E95/5CF44B6D" Ref="C412"  Part="1" 
F 0 "C412" H 9915 2846 50  0000 L CNN
...
AR Path="/5CF15E95/5CF44B74" Ref="#PWR0412"  Part="1" 
F 0 "#PWR0412" H 9800 2400 50  0001 C CNN
...
AR Path="/5CF15E95/5CF44B7B" Ref="#PWR0413"  Part="1" 
F 0 "#PWR0413" H 9800 2800 50  0001 C CNN
...
AR Path="/5CF15E95/5CC6C599" Ref="R402"  Part="1" 
F 0 "R402" H 2070 3696 50  0000 L CNN
...
AR Path="/5CF15E95/5CC6C5A0" Ref="R403"  Part="1" 
F 0 "R403" H 2070 5996 50  0000 L CNN
F 1 "47k" H 2070 5905 50  0000 L CNN
F 2 "Resistor_SMD:R_0805_2012Metric" V 1930 5950 50  0001 C CNN
...
AR Path="/5CF15E95/5CC6C5A9" Ref="#PWR0402"  Part="1" 
F 0 "#PWR0402" H 2000 6050 50  0001 C CNN
...
AR Path="/5CF15E95/5CC6C5AF" Ref="#PWR0401"  Part="1" 
F 0 "#PWR0401" H 2000 3650 50  0001 C CNN
...
AR Path="/5CF15E95/5CD5880B" Ref="R401"  Part="1" 
F 0 "R401" H 1570 5996 50  0000 L CNN
...
U 1 1 5CF9AF83
P 6800 3800
AR Path="/5CF9AF83" Ref="C?"  Part="1" 
AR Path="/5CF15E95/5CF9AF83" Ref="C409"  Part="1" 
F 0 "C409" H 6918 3846 50  0000 L CNN
F 1 "1000u/63V/Low ESR" H 6918 3755 50  0000 L CNN
F 2 "Capacitor_THT:CP_Radial_D17.0mm_P7.50mm" H 6838 3650 50  0001 C CNN
...
U 1 1 5CF9FA2C
P 6800 6150
AR Path="/5CF9FA2C" Ref="C?"  Part="1" 
AR Path="/5CF15E95/5CF9FA2C" Ref="C410"  Part="1" 
F 0 "C410" H 6918 6196 50  0000 L CNN
F 1 "1000u/63V/Low ESR" H 6918 6105 50  0000 L CNN
F 2 "Capacitor_THT:CP_Radial_D17.0mm_P7.50mm" H 6838 6000 50  0001 C CNN
...
U 1 1 5CFA7DFF
P 8500 3500
F 0 "J401" H 8579 3542 50  0000 L CNN
F 1 "MOTOR" H 8579 3451 50  0000 L CNN
F 2 "MountingHole:MountingHole_5.3mm_M5_Pad" H 8500 3500 50  0001 C CNN
...
U 1 1 5CFA7EE9
P 8500 3700
F 0 "J402" H 8579 3748 50  0000 L CNN
F 1 "~MOTOR" H 8579 3650 50  0000 L CNN
F 2 "MountingHole:MountingHole_5.3mm_M5_Pad" H 8500 3700 50  0001 C CNN
...
Wire Wire Line
	4750 6400 5800 6400
Text HLabel 8400 2500 3    50   Output ~ 0
VRAIL
Wire Wire Line
	8400 2100 8400 2500
$Comp
...
U 1 1 5CE2F9D5
P 5800 3300
AR Path="/5CE2F9D5" Ref="C?"  Part="1" 
AR Path="/5CF15E95/5CE2F9D5" Ref="C405"  Part="1" 
F 0 "C405" H 5918 3346 50  0000 L CNN
F 1 "1000u/63V/Low ESR" H 5918 3255 50  0000 L CNN
F 2 "Capacitor_THT:CP_Radial_D17.0mm_P7.50mm" H 5838 3150 50  0001 C CNN
...
U 1 1 5CE2FA67
P 5800 5600
AR Path="/5CE2FA67" Ref="C?"  Part="1" 
AR Path="/5CF15E95/5CE2FA67" Ref="C406"  Part="1" 
F 0 "C406" H 5918 5646 50  0000 L CNN
F 1 "1000u/63V/Low ESR" H 5918 5555 50  0000 L CNN
F 2 "Capacitor_THT:CP_Radial_D17.0mm_P7.50mm" H 5838 5450 50  0001 C CNN
